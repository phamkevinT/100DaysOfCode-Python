...
# Turtle naturally starts in center so we correct this to start lower towards diagonal bottom left
tim.setheading(225)
tim.forward(300)
tim.setheading(0)

# Numbers of dots to be produced
number_of_dots = 100
...
for dot_count in range(1, number_of_dots + 1):
    ...
    # Once we reach 10 dots in the row, make turtle return to the left starting side to start all over
    if dot_count % 10 == 0:
        tim.setheading(90)
        tim.forward(50)
        tim.setheading(180)
